  ...
  const categories = [
    {
      title: "Fruits",
      description:
        "Our fruit selection showcases the finest of nature’s bounty, cultivated with precision and care to meet the highest standards of quality. From sun-ripened local produce to carefully sourced exotic varieties, each fruit embodies freshness, vibrant flavors, and exceptional nutritional value. At Green, we ensure that every fruit reflects our commitment to sustainable farming practices, meticulous handling, and timely delivery, bringing you the very best of the harvest.",
  ...
  return (
    <div className="bg-gray-50 py-16 px-6 lg:px-20">
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-[#FF8800] mb-4">Green Products</h2>
